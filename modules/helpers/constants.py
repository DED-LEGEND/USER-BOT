class First:
    ...
    REPO = 'Click <a href="GitHub.com/adityabots/kaaluserbot">here</a> to open Usebot\'s GitHub page.'
    CREATOR = 'I was created by my master <a href="https://github.com/adityabots">Kaal</a> on a rainy day.'
