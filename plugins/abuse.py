...
REPLY = (
    ...
    "Wahhh Bato to kitna MADARchod BETA HAI MERE baap ki izzat tak nahi karta?必",
    "abee o nibba Lodi den ki Abhi nibbi ke sath transgender wali harkate krr yaha abhi chako walii harkate naa kr",
    "Wahh behencooo Teri kitni mast hai ?中aur eak baar chodne de?中",
    ...
    "Bohot randi chod ke dekhe lakin tu sabse bada wala hai?不",
    ...
    "Teri maan ko itna chodu gha na ki wo chila chila ke thak jayagi?必",
