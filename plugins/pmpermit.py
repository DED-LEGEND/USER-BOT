...
from modules.config import SUDO_USERS as Adminsettings, LOGS_GROUP_ID as LOG_GROUP
from plugins.help import *
from modules.config import ALIVE_PIC

Alive_msg = f"𝐊𝐚𝐚𝐥 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐏𝐫𝐨𝐭𝐞𝐜𝐭𝐢𝐨𝐧 🔱 \n\n"
Alive_msg += f"◈ ━━━━━━ ◆ ━━━━━━ ◈ \n"
Alive_msg += f"► ᴠᴇʀsɪᴏɴ : `2.0 Pro` \n"
Alive_msg += f"► ᴘʏʀᴏ ᴠᴇʀsɪᴏɴ : `1.4.15` \n"
Alive_msg += f"► Rᴇᴘᴏ : [Gɪᴛʜᴜʙ](https://GitHub.com/adityabots/kaaluserbot) \n"
Alive_msg += f"► Sᴜᴘᴘᴏʀᴛ : [Jᴏɪɴ.](https://t.me/adityadiscus) \n"
Alive_msg += f"► Cʜᴀɴɴᴇʟ : [Jᴏɪɴ.](https://t.me/adityaserver) \n"
