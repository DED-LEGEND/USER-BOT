...
async def restart_get(client: Client, message: Message):
    try:
        kaal = await message.reply_text("**Restarting userbot...**")
        await restart(message, restart_type="restart")
    except:
        await kaal.edit_text("**An error occured...**")
...
async def update(client: Client, message: Message):
    try:
        ...
        link = "https://github.com/adityabots/kaaluserbot/archive/refs/heads/kaal.zip"
        ...
        shutil.make_archive("temp/archive", "zip", "temp/kaaluserbot-kaal/")
